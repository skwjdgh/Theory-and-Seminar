# whisper_module.py (st.audio_input 호환 버전)
import io
import subprocess
import whisper
import torch
...
class WhisperRecognizer:
    ...
    def recognize_audio_input(self, audio_bytes: bytes) -> str:
        ...
        st.audio_input은 이미 표준화된 포맷을 제공하므로 처리가 더 간단합니다.
        """
        try:
            ...
            # st.audio_input의 데이터는 보통 WAV 형식이지만, 안전을 위해 변환
            try:
                # 직접 사용 시도
